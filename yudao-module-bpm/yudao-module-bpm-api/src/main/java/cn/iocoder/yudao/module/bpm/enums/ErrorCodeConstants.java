...
public interface ErrorCodeConstants {
    ...
    ErrorCode TASK_ASSIGN_USER_NOT_EXISTS = new ErrorCode(1_009_006_005, "操作失败，原因：未指定下一个任务的审批人");
    ...
    // ========== 进件工单 1-009-012-000 ==========
    ErrorCode CRM_INPUT_NOT_EXISTS = new ErrorCode(1_009_012_000, "进件工单不存在");
    ErrorCode BPM_ORDER_POOL_DISABLE = new ErrorCode(1_009_012_000, "抢单失败");

    // ========== 工作流与决策引擎交互 1-009-013-000 ==========
    ErrorCode BPM_ZDE_DS_API_NOT_EXISTS = new ErrorCode(1_009_013_000, "获取数据表单接口不存在");
}
